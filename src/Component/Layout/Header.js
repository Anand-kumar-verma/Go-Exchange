...
const Header = () => {
    return (
        <>
            <div className="flex justify-between p-2" style={{ backgroundColor: bgheader }}>
                <div className="px-2">
                    <img 
                ...
                >
                    ...
                    <p className="text-center sm:text-left">Balance: 0 <br /> Exp: 0</p>
                    <p className="hidden sm:block">Demo</p>
                </div>
            </div>
            <div className='flex text-sm  font-bold justify-start gap-5 p-3 px-5' style={{ backgroundColor: bgball, color: bgtext }}>
